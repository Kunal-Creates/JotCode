...
// .wrangler/tmp/pages-wVVhYN/functionsWorker-0.12121695656783293.mjs
...
async function onRequest(context) {
  ...
  if (!response.ok) {
    ...
    return new Response(JSON.stringify(errorData), {
      ...
      // Pass along Google's error status
      headers: { "Content-Type": "application/json" }
    });
  }
...
// .wrangler/tmp/bundle-QqunER/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-QqunER/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.12121695656783293.js.map
